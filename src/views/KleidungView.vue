...
const kleidungItems = [
  // Zeile 1: Mütze, Ohrstöpsel, Schaal
  { id: 'muetze', text: 'Mütze', type: 'clothing' },
  { id: 'ohrstoepsel', text: 'Ohrstöpsel', type: 'clothing' },
  { id: 'schaal', text: 'Schaal', type: 'clothing' },
  
  // Zeile 2: Hemd, T-Shirt, Pullover
  { id: 'hemd', text: 'Hemd', type: 'clothing' },
  { id: 'tshirt', text: 'T-Shirt', type: 'clothing' },
  { id: 'pullover', text: 'Pullover', type: 'clothing' },
  
  // Zeile 3: Hose, Gürtel, Socken
  { id: 'hose', text: 'Hose', type: 'clothing' },
  { id: 'guertel', text: 'Gürtel', type: 'clothing' },
  { id: 'socken', text: 'Socken', type: 'clothing' },
...
function selectKleidung(kleidungId: string) {
  ...
  switch (kleidungId) {
    case 'zurueck':
      ...
      break
    default:
      console.log('Selected clothing:', kleidungId)
      // Hier könnte später die Kleidungs-Auswahl gespeichert werden
      ...
      <div class="max-w-8xl mx-auto">
        ...
        <div class="mb-64 text-center">
          <div class="bg-blue-100 dark:bg-blue-900 rounded-xl p-20 max-w-8xl mx-auto">
            ...
            <div class="font-bold text-blue-900 dark:text-blue-100" style="font-family: 'Source Code Pro', monospace; font-weight: 300; font-size: 4rem;">
              {{ selectedKleidung || 'Wählen Sie ein Kleidungsstück aus' }}
            </div>
          </div>
        </div>
         <!-- Abstandshalter -->
        ...
        <div class="space-y-20 mt-32 mb-48">
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in kleidungItems.slice(0, 3)"
              :key="item.id"
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in kleidungItems.slice(3, 6)"
              :key="item.id"
              @click="selectKleidung(item.id)"
              class="transition-all duration-300 font-medium hover:scale-110"
              :style="{
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in kleidungItems.slice(6, 9)"
              :key="item.id"
              @click="selectKleidung(item.id)"
              class="transition-all duration-300 font-medium hover:scale-110"
              :style="{
        ...
        <div class="mt-16 text-center">
          <div class="bg-blue-100 dark:bg-blue-900 rounded-xl p-12 max-w-4xl mx-auto">
            ...
            <p class="text-2xl text-blue-700 dark:text-blue-300" style="font-family: 'Source Code Pro', monospace; font-weight: 300;">
              <strong>Kurz blinzeln ({{ settingsStore.settings.blinkSensitivity }}s):</strong> Kleidungsstück auswählen<br>
              <strong>Rechte Maustaste:</strong> Kleidungsstück auswählen<br>
              <strong>Auto-Modus:</strong> Automatischer Durchlauf durch alle Kleidungsstücke
            </p>
          </div>
        </div>
      </div>
