...
const hygieneItems = [
  // Zeile 1: auf die Toilette, Zähne putzen, duschen, baden
  { id: 'toilette', text: 'auf die Toilette', type: 'hygiene' },
  { id: 'zaehne_putzen', text: 'Zähne putzen', type: 'hygiene' },
  { id: 'duschen', text: 'duschen', type: 'hygiene' },
  { id: 'baden', text: 'baden', type: 'hygiene' },
  
  // Zeile 2: Hände waschen, Haare kämmen, umziehen
  { id: 'haende_waschen', text: 'Hände waschen', type: 'hygiene' },
  { id: 'haare_kaemmen', text: 'Haare kämmen', type: 'hygiene' },
  { id: 'umziehen', text: 'umziehen', type: 'hygiene' },
    ...
    <main class="flex-1 flex items-center justify-center p-16">
      <div class="max-w-8xl mx-auto">
        ...
        <div class="mb-64 text-center">
          <div class="bg-blue-100 dark:bg-blue-900 rounded-xl p-20 max-w-8xl mx-auto">
            ...
            <div class="font-bold text-blue-900 dark:text-blue-100" style="font-family: 'Source Code Pro', monospace; font-weight: 300; font-size: 4rem;">
              {{ selectedHygiene || 'Wählen Sie eine Hygiene-Aktivität aus' }}
            </div>
          </div>
        </div>
         <!-- Abstandshalter -->
        ...
        <div class="space-y-20 mt-32 mb-48">
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in hygieneItems.slice(4, 7)"
              :key="item.id"
              @click="selectHygiene(item.id)"
              class="transition-all duration-300 font-medium hover:scale-110"
              :style="{
        ...
        <div class="mt-16 text-center">
          <div class="bg-blue-100 dark:bg-blue-900 rounded-xl p-12 max-w-4xl mx-auto">
            ...
            <p class="text-2xl text-blue-700 dark:text-blue-300" style="font-family: 'Source Code Pro', monospace; font-weight: 300;">
              <strong>Kurz blinzeln ({{ settingsStore.settings.blinkSensitivity }}s):</strong> Hygiene-Aktivität auswählen<br>
              <strong>Rechte Maustaste:</strong> Hygiene-Aktivität auswählen<br>
              <strong>Auto-Modus:</strong> Automatischer Durchlauf durch alle Hygiene-Aktivitäten
            </p>
          </div>
        </div>
      </div>
