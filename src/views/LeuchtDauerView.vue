    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
      ...
      <main class="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl font-bold text-gray-800 dark:text-gray-200 font-source-code mb-4">
        ...
        >
          ...
          >
            <div class="text-center">
              ...
              <div class="text-lg text-gray-600 dark:text-gray-400">{{ item.description }}</div>
            </div>
          </button>
        </div>
        ...
        <div class="mt-16 text-center">
          <div class="text-lg text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <p>Kurz blinzeln (0.5s): Geschwindigkeit auswählen</p>
