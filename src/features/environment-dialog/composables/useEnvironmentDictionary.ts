// useEnvironmentDictionary.ts - Central data and language logic for Environment Dialog
...
import {
  ...
  ID_ZIMMER,
  ID_GEGENSTAENDE
} from '../data/environmentDialogData'
...
export function useEnvironmentDictionary() {
  return {
    mainRegions,
    subRegionMap,
    getSubRegions,
