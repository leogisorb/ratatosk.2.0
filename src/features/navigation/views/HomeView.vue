      ...
      <div class="content-wrapper">
        ...
        <div class="grid-container desktop-grid" v-if="!isMobile">
          ...
          >
            <div class="tile-icon-container">
              <img 
                src="/ratatosk.2.0/images/comment-dots.svg" 
                alt="UNTERHALTEN" 
                class="tile-icon"
          ...
          >
            <div class="tile-icon-container">
              <img 
                src="/ratatosk.2.0/images/user.svg" 
                alt="ICH" 
                class="tile-icon"
          ...
          >
            <div class="tile-icon-container">
              <img 
                src="/ratatosk.2.0/images/headache.svg" 
                alt="SCHMERZEN" 
                class="tile-icon"
          ...
          >
            <div class="tile-icon-container">
              <img 
                src="/ratatosk.2.0/images/house-chimney.svg" 
                alt="UMGEBUNG" 
                class="tile-icon"
          ...
          >
            <div class="tile-icon-container">
              <img 
                src="/ratatosk.2.0/images/settings-sliders.svg" 
                alt="EINSTELLUNGEN" 
                class="tile-icon"
