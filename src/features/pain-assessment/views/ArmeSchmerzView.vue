...
const armeBereiche = [
  // Zeile 1: Finger, Handfläche, Handrücken, Unterarm, Ellenbogen
  ...
  // Zeile 2: Ellenbeuge, Oberarm, Schulter, Achsel, Zurück
      ...
      <div class="max-w-8xl mx-auto">
        ...
        <div class="space-y-20 mt-32 mb-48">
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in armeBereiche.slice(0, 5)"
              :key="item.id"
            ...
            >
              <!-- SVG für Finger -->
              <div v-if="item.id === 'finger'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/finger.svg" alt="Finger" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Handfläche -->
              <div v-else-if="item.id === 'handflaeche'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/handfläche.svg" alt="Handfläche" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Handrücken -->
              <div v-else-if="item.id === 'handruecken'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/handrücken.svg" alt="Handrücken" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Unterarm -->
              <div v-else-if="item.id === 'unterarm'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/unterarm.svg" alt="Unterarm" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Ellenbogen -->
              <div v-else-if="item.id === 'ellenbogen'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/ellebogen.svg" alt="Ellenbogen" class="w-full h-full object-contain" />
              </div>
          ...
          <div class="flex justify-center space-x-32">
            <button
              v-for="(item, index) in armeBereiche.slice(5, 10)"
              :key="item.id"
              @click="selectArmeBereich(item.id)"
              class="transition-all duration-300 font-medium hover:scale-110 flex flex-col items-center"
              :style="{
            ...
            >
              <!-- SVG für Ellenbeuge -->
              <div v-if="item.id === 'ellenbeuge'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/ellebeuge.svg" alt="Ellenbeuge" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Oberarm -->
              <div v-else-if="item.id === 'oberarm'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/oberarm.svg" alt="Oberarm" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Schulter -->
              <div v-else-if="item.id === 'schulter'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/schulter.svg" alt="Schulter" class="w-full h-full object-contain" />
              </div>
              
              <!-- SVG für Achsel -->
              <div v-else-if="item.id === 'achsel'" class="mx-auto mb-2" style="width: 150px; height: 150px; max-width: 150px; max-height: 150px;">
                <img src="/achsel.svg" alt="Achsel" class="w-full h-full object-contain" />
              </div>
