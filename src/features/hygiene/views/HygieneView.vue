...
const hygieneItems = [
  ...
  { id: 'toilette', text: 'auf die Toilette', type: 'hygiene', emoji: '🚽' },
  { id: 'zaehne_putzen', text: 'Zähne putzen', type: 'hygiene', emoji: '🦷' },
  ...
  { id: 'haende_waschen', text: 'Hände waschen', type: 'hygiene', emoji: '🧼' },
  { id: 'haare_kaemmen', text: 'Haare kämmen', type: 'hygiene', emoji: '💇' },
  { id: 'umziehen', text: 'umziehen', type: 'hygiene', emoji: '👕' },
