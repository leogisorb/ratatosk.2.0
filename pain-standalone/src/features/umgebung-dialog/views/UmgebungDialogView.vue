          ...
          <div class="carousel-container">
            ...
            <div class="carousel-content">
              <div 
                ...
                @click="selectSubSubRegion(subSubRegion.id)"
...
const handleKeydown = (event: KeyboardEvent) => {
  if (currentState.value === 'mainView') {
    ...
    switch (event.key) {
      ...
      case 'Enter':
      case ' ':
        const currentSubSubRegion = currentSubSubRegions.value[currentTileIndex.value]
        if (currentSubSubRegion) {
          selectSubSubRegion(currentSubSubRegion.id)
        }
        break
    }
  }
